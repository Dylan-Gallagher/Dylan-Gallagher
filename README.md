...
|---|---|---|
| [arm-lab](https://github.com/Dylan-Gallagher/arm-lab) | A serial-manipulator stack in Rust: model-consistent FK/Jacobians, damped least-squares IK, collision-aware RRT planning, trajectory generation, and MuJoCo control | [v0.2.0 evidence release](https://github.com/Dylan-Gallagher/arm-lab/releases/tag/v0.2.0) · [Multi-scene report](https://github.com/Dylan-Gallagher/arm-lab/blob/v0.2.0/docs/multi_query_results.md) · Attached payload: [protocol](https://github.com/Dylan-Gallagher/arm-lab/blob/v0.2.0/docs/attached_payload_protocol.md) / [results](https://github.com/Dylan-Gallagher/arm-lab/blob/v0.2.0/docs/attached_payload_results.md) · [Release CI](https://github.com/Dylan-Gallagher/arm-lab/actions/runs/32000191394) · [Citation](https://github.com/Dylan-Gallagher/arm-lab/blob/v0.2.0/CITATION.cff) |
